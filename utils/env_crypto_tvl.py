...
def fetch_env_crypto_tvl_data():
    # Read csv file into DataFrame
    df = pd.read_csv(Path(f"data/env_crypto_tvl_data.csv"), parse_dates=False)
...
#     bar = df.hvplot.bar(x="Symbol", y="RatedPowerKW", title="Rated Power per Cryptocurrency", color="Efficiency", hover_cols=["Efficiency","Symbol", "Algorithm"],width=900, height=400)
